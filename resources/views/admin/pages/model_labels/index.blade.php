            ...
            $('#model_labels').DataTable({
                ...
                columns: [
                    ...
                    { data: 'label_z', name: 'label_z' },
                    {
                        ...
                        "orderable": false,
                        render: function ( data, type, row, meta ) {
                            return '<button class="editor-edit fa fa-edit fa-2x" data-toggle="modal" data-target="#modelLabelModal" data-title="Edit Model Label" data-id="'+data+'"></button><button class="editor-remove fa fa-trash-o fa-2x" style="color: red;" data-id="'+data+'"></button>';
                        }
                    }
                ]
            });
