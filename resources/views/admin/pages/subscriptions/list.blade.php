            ...
            <table class="table table-hover table-bordered" id="subscriptions" >
                <thead>
                    <tr>
                        ...
                        <th class="align-left">{{ __('User') }}</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#subscriptionModal').on('show.bs.modal', function (e) {
                ...
                if ($subscription_id) {
                    $.ajax({
                        url: '{{ env("APP_WEB_API_URL") }}/{{ env("APP_WEB_API_VERSION" )}}/subscriptions/'+$subscription_id,
                        type: 'GET',
            ...
            $(".save-btn").click(function(e){
                ...
                if ($subscription_id) {
                    ...
                    request = {
                        url: '{{ env("APP_WEB_API_URL") }}/{{ env("APP_WEB_API_VERSION" )}}/subscriptions',
                        method: 'POST'
                    }
                }
