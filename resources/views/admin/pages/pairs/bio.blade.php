...
@section('page-title')
    {{ __('Anew Avenue Biomagnestim | Administrator - Pairs - Bio') }}
@stop
@section('styles')
    @parent
...
@section('content')
    ...
    <div id="content-container">
        <h2>
            ...
            <button class="editor-new fa fa-upload" onclick="window.location.href='/admin/pairs/import?scan_type=body_scan'"></button>
        </h2><br/>
