...
@section('page-title')
    {{'Anew Avenue Biomagnestim | Data Cache - Client Info - Bio'}}
@stop
@section('styles')
    @parent
...
@section('content')
    ...
    <div id="content-container" style="margin: 20px; margin-bottom: 110px;" ng-cloak="" ng-controller="DataCacheClientShowBioCtrl as ctrl">
