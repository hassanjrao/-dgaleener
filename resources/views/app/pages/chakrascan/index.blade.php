            ...
            <div class="row col-md-12" style="padding-left: 0;">
                ...
                <div class="col-md-6 col-xs-6 scan-point-container" ng-cloak="">
                    ...
                    <div class="row" style="margin: 8px 0;" ng-if="(ctrl.model_labels.length > 0) && !ctrl.disable_client_selection">
                        ...
                        <a href="/data_cache/clients/<% ctrl.client.id %>?scan_type=chakra_scan" target="_blank"><button class="btn-data-cache" style="margin: 8px; margin-right: 0; width: 66px;" ng-disabled="!(ctrl.client | valPresent)" ng-if="ctrl.clients | valPresent">View</button></a>
