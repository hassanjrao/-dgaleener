                ...
                <ul class="nav">
                    <li>
                        <a href="{{ route('app.dashboard') }}" class="active">
                            <img src="{{ asset('images/homepage/learn-more.png') }}" alt="{{ env('APP_TITLE') }} | Learn more about Biomagnetism "/>
                            <span>Learn More</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ Auth::user() ? route('app.bodyscan') : route('app.bodyscan.info') }}">
                            <img src="{{ asset('images/homepage/bodyscan.png') }}" alt="{{ env('APP_TITLE') }} | Body Scan"/>
                            <span>Body Scan</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ Auth::user() ? route('app.chakrascan') : route('app.chakrascan.info') }}">
                            <img src="{{ asset('images/homepage/chakrascan.png') }}" alt="{{ env('APP_TITLE') }} | Chakra Scan"/>
                            <span>Chakra Scan</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ Auth::user() ? route('app.data_cache') : route('app.data_cache.info') }}">
                            <img src="{{ asset('images/homepage/dashboard.png') }}" alt="{{ env('APP_TITLE') }} | Data Cache"/>
                            <span>Data Cache</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ Auth::user() ? route('app.bioconnect') : route('app.bioconnect.info') }}">
                            <img src="{{ asset('images/homepage/bioconnect.png') }}" alt="{{ env('APP_TITLE') }} | Bio Connect"/>
                            <span>Bio Connect</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('app.products.index') }}">
                            <img src="{{ asset('images/homepage/more.png') }}" alt="{{ env('APP_TITLE') }} | More"/>
                            <span>More</span>
                        </a>
                    </li>
                </ul>
